...
return [
    ...
    */
    ...
    |
    | Phase 1: 30 days (43200 minutes) - generous default for transition period
    | Phase 2: Reduce to 720 (12 hours) after monitoring token usage patterns
    |
    */
    ...
    */
    ...
    'middleware' => [
        ...
        'validate_csrf_token' => ApiCsrfExemption::class,
    ],
