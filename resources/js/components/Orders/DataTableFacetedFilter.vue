  ...
  <Popover>
    <PopoverTrigger as-child>
      <Button variant="outline" size="sm" class="h-8 border-dashed text-xs">
        <SlidersHorizontal class="mr-2 h-2 w-2" />
        Filter: {{ title }}
        ...
        <CommandList>
          ...
          <CommandGroup>
            ...
            >
              ...
              <span v-if="facets?.get(option.value)" class="ml-auto flex h-4 w-4 items-center justify-center text-xs">
