...
import DataTableColumnHeader from '@/components/user/DataTableColumnHeader.vue'
import DataTableRowActions from '@/components/user/DataTableRowActions.vue'
...
export const columns: ColumnDef<User>[] = [
  ...
  },
  {
    ...
    enableSorting: false,
    cell: ({ row }) =>
      h('div', { class: 'w-auto text-sm' }, h(Badge, { variant: row.getValue('deleted_at') ? 'destructive' : 'active' }, () => row.getValue('deleted_at') ? 'inactive' : 'active')),
  },
  {
    accessorKey: 'id',
