...
WOOSOO_TABLET_HTTPS_PORT="${WOOSOO_TABLET_HTTPS_PORT:-4443}"
...
set_env "TABLET_HTTPS_PORT" "$WOOSOO_TABLET_HTTPS_PORT"
...
set_env "SANCTUM_STATEFUL_DOMAINS" "${WOOSOO_HOST},${WOOSOO_HOST}:443,${WOOSOO_HOST}:80,${WOOSOO_HOST}:${WOOSOO_TABLET_HTTPS_PORT}"
set_env "CORS_ALLOWED_ORIGINS" "${WOOSOO_SCHEME}://${WOOSOO_HOST},http://${WOOSOO_HOST},${WOOSOO_SCHEME}://${WOOSOO_HOST}:${WOOSOO_TABLET_HTTPS_PORT}"
...
echo "Tablet PWA URL from current compose.yaml: ${WOOSOO_SCHEME}://${WOOSOO_HOST}:${WOOSOO_TABLET_HTTPS_PORT}"
